...
# Setup CBR/UDP traffic flow from station 1 to AP
...
# Setup CBR/TCP traffic flow from station 2 to AP
...
$cbr_(1) set interval_ 0.0005
$cbr_(1) set random_ 1
$cbr_(1) set maxpkts_ 10000
$cbr_(1) attach-agent $tcp_(1)
...
# setup FTP/TCP traffic flow from station 2 to AP
set tcp_(1) [new Agent/TCP]
$ns_ attach-agent $node_(2) $tcp_(1)
