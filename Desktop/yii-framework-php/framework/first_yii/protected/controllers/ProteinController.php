...
$grid = "/biomed/user/l/louacheni";
$dirac = "/home/dida/DIRAC/scripts";
...
class ProteinController extends Controller {
    ...
    public function loadModel($id) {
        $model = Protein::model()->findByPk($id);
        if ($model === null)
            throw new CHttpException(404, 'The requested page does not exist.');
        return $model;
    }
    // 
    public function actionReceiveValue(){
        echo $_POST['name'];
        print_r($_POST);
    }
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'protein-form') {
