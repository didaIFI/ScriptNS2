...
//	    $html= CHtml::link(
//	        Yii::app()->baseUrl."/protected/views/project/fileUpload/". $this->file_name,
//	        Yii::app()->createAbsoluteUrl("ligand/download",array("id"=>$this->ligand_id))
//	    );
//	    return $html;
//	}
}