...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.container = $('<div class="ui-multiselect ui-helper-clearfix ui-widget" style="margin-left:auto; margin-right:auto; width:700px;"></div>').insertAfter(this.element);
		this.selectedContainer = $('<div class="ui-widget-content list-container selected"></div>').appendTo(this.container);
		this.availableContainer = $('<div class="ui-widget-content list-container available" style="width:324px;"></div>').appendTo(this.container);
